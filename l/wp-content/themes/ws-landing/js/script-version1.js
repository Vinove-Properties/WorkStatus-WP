...
function vcCmnFormValidation(){
    ...
    if (
        ((document.getElementById("checkerror").innerHTML = ""),
        !0 !== vcSpaceChecker(email.value.trim()) || !0 !== vcSpaceChecker(fname.value.trim()) || !0 !== vcSpaceChecker(phone.value.trim()) || !0 !== vcSpaceChecker(company.value.trim()) || !0 !== vcSpaceChecker(captcha.value.trim()))
    )
        return !1;
    {
