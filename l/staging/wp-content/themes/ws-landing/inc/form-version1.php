...
<form name="theForm" method="post" id="ws-lead-form" action="<?php echo site_url('/thanks'); ?>" 
  onsubmit="return vcCmnFormValidation(<?php echo ( sixTwoTpl() ) ? 'true' : '';  ?>);">
  <div class="form-wrap">    
      <div class="form-group">
        <input type="text" id="first_name" placeholder="Full Name*" name="fname" maxlength="30" />
        <span class="error"></span>
      </div>
      
      <div class="form-group">
        <input type="text" id="cont_email" placeholder="E-Mail*" name="email" maxlength="50" />
        <span class="error"></span>
      </div>
      ...
      <div class="form-group companygroup">
        <input type="text" name="company" maxlength="100" class="form-control" id="company_name" placeholder="Company Name*" />
        <span class="error"></span>
      </div>

      <?php if( sixTwoTpl() ) : ?>
      <div class="form-group">
        <div id="ft-hcount" class="form-text-cont width-full">
          <div class="select-box active input-field" onclick="apnSelect('ft-hcount');">
            <input type="hidden" id="ft-size" name="team-size" value="">
            <span class="error"></span>
            <a href="javascript:void(0);" class="select-first" id="label-fth">Select company headcount</a>
            <span class="arrow-btn"></span>
          </div>
          <div class="select-list">
            <ul class="in-options">
              <li onclick="setoptValue('Self-employed', 'label-fth', 'ft-size', 'ft-hcount');">Self-employed</li>
              <li onclick="setoptValue('1-10', 'label-fth', 'ft-size', 'ft-hcount');">1-10</li>
              <li onclick="setoptValue('11-50', 'label-fth', 'ft-size', 'ft-hcount');">11-50</li>
              <li onclick="setoptValue('51-200', 'label-fth', 'ft-size', 'ft-hcount');">51-200</li>
              <li onclick="setoptValue('201-500', 'label-fth', 'ft-size', 'ft-hcount');">201-500</li>
              <li onclick="setoptValue('501-1000', 'label-fth', 'ft-size', 'ft-hcount');">501-1000</li>
              <li onclick="setoptValue('1001-5000', 'label-fth', 'ft-size', 'ft-hcount');">1001-5000</li>
              <li onclick="setoptValue('5001-10000', 'label-fth', 'ft-size', 'ft-hcount');">5001-10000</li>
              <li onclick="setoptValue('10000+', 'label-fth', 'ft-size', 'ft-hcount');">10000+</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
      <textarea class="form-control" name="requirement" id="ft-requirement" placeholder="Please tell us about your requirements"></textarea>
      <span class="error"></span>
      </div>
      <?php endif; ?>
