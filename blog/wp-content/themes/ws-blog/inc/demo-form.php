  ...
  <div id="formPopup" class="popup-wrapper">
    <div class="popWrap">
      <div class="popup-content">
        ...
        <form method="post" id="ws-lead-form" action="https://www.workstatus.io/thanks-demo-submission.php" 
          onsubmit="return vcCmnFormValidation();">
          <div class="form-wrap">
            <div class="form-group">
              <label>First Name*</label>
              <input type="text"  id="first_namedm" placeholder="Enter your first name" name="fname" maxlength="30">
            ...
            <div class="form-group">
              <div id="help-ul" class="form-text-cont width-full">
                ...
                <div class="select-box active input-field" onclick="apnSelectDM('help-ul');">
                ...
                <div class="select-list">
                  <ul class="in-options">
                    <li onclick="setoptValueDM('Self-employed', 'label-wehelp', 'team-size', 'help-ul');">Self-employed</li>
                    <li onclick="setoptValueDM('1-10', 'label-wehelp', 'team-size', 'help-ul');">1-10</li>
                    <li onclick="setoptValueDM('11-50', 'label-wehelp', 'team-size', 'help-ul');">11-50</li>
                    <li onclick="setoptValueDM('51-200', 'label-wehelp', 'team-size', 'help-ul');">51-200</li>
                    <li onclick="setoptValueDM('201-500', 'label-wehelp', 'team-size', 'help-ul');">201-500</li>
                    <li onclick="setoptValueDM('501-1000', 'label-wehelp', 'team-size', 'help-ul');">501-1000</li>
                    <li onclick="setoptValueDM('1001-5000', 'label-wehelp', 'team-size', 'help-ul');">1001-5000</li>
                    <li onclick="setoptValueDM('5001-10000', 'label-wehelp', 'team-size', 'help-ul');">5001-10000</li>
                    <li onclick="setoptValueDM('10000+', 'label-wehelp', 'team-size', 'help-ul');">10000+</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="captForm">
              ...
              <div class="form-group justify">                
                ...
                <input type="hidden" name="tracking_ip" value="<?php echo wsBlogUserIP();?>">
                ...
                <input type="hidden" name="is-blog" value="1">
