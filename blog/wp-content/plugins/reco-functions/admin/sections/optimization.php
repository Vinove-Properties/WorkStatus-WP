...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
            ...
            'desc' => __('<b>Standard:</b> is render blocking but the CSS appears inmediatly.<br><b>Important:</b> if you are using PageSpeed on your hosting, standard method is recommended.', 'epcl_framework'),
            'options'  => array(
                'standard' => esc_html__('Standard (head)', 'epcl_framework'),
                // 'prefetch' => esc_html__('Prefetch (recommended)', 'epcl_framework'),
