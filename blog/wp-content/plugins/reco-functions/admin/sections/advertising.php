...
Redux::setSection( $opt_name, array(
	...
	'fields' => array(
        // Single X paragraph
        array(
			'id' => 'ads_single_paragraph',
			'type' => 'section',
			'title' => __('Every X Paragraph', 'epcl_framework'),
			'subtitle' => __('This section will show an advertise between single post content.', 'epcl_framework'),
			'indent' => true
		),
		array(
			'id' => 'ads_enabled_single_paragraph',
			'type' => 'switch',
			'title' => esc_html__('Display Advertise', 'epcl_framework'),
			'desc' => esc_html__('Enable or disable this particular ads section.', 'epcl_framework'),
			'default' => 0
        ...
        array(
			'id' => 'ads_mobile_single_paragraph',
			'type' => 'switch',
			'title' => esc_html__('Display Advertise on Mobile', 'epcl_framework'),
			'desc' => esc_html__('Disabling ads on mobile can improve your website speed on cellphones.', 'epcl_framework'),
            'default' => 1,
            'required' => array('ads_enabled_single_paragraph', '=', '1')
        ),
        array(
			'id' => 'ads_amount_single_paragraph',
			'type' => 'spinner',
			'required' => array('ads_enabled_single_paragraph', '=', '1'),
			'validate' => 'numeric',
            'title' => esc_html__('Position between Paragraphs', 'epcl_framework'),
            'subtitle' => esc_html__('(Optional)', 'epcl_framework'),
            'desc' => esc_html__('Default: 10', 'epcl_framework'),
            'default'  => '10',
            'min'      => '1',
            'step'     => '1',
            'max'      => '100',
        ...
        array(
			'id' => 'ads_max_single_paragraph',
			'type' => 'spinner',
			'required' => array('ads_enabled_single_paragraph', '=', '1'),
			'validate' => 'numeric',
            'title' => esc_html__('Max Amount of ADS per page', 'epcl_framework'),
            'subtitle' => esc_html__('(Optional)', 'epcl_framework'),
            'desc' => esc_html__('e.g. 2', 'epcl_framework'),
            'default'  => '5',
            'min'      => '1',
            'step'     => '1',
            'max'      => '100',
		...
		array(
			'id' => 'ads_image_single_paragraph',
			'type' => 'media',
			'required' => array('ads_type_single_paragraph', '=', 'image'),
			'url' => true,
			'preview'=> true,
			'title' => esc_html__('Advertising Image', 'epcl_framework'),
//			'desc' => esc_html__('Recommended sizes - width: 728px, height: 90px.', 'epcl_framework'),
		...
		array(
			'id' => 'ads_code_single_paragraph',
			'type' => 'textarea',
			'required' => array('ads_type_single_paragraph', '=', 'code'),
			'title' => esc_html__('Custom Code', 'epcl_framework'),
			'desc' => esc_html__('Here you can paste your custom advertising code.', 'epcl_framework')
		),
		array(
			'id' => 'ads_mt_single_paragraph',
			'type' => 'slider',
			'title' => esc_html__('Spacing Top', 'epcl_framework'),
			'subtitle' => '',
...
//			'desc' => esc_html__('Recommended sizes - width: 728px, height: 90px.', 'epcl_framework'),
		...
		array(
			...
			'subtitle' => __('This section will show an advertise at the end of the single post content.', 'epcl_framework'),
			'indent' => true
		),
		array(
