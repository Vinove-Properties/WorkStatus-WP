...
if ( ! class_exists( 'epcl_social' ) ) {
	class epcl_social extends WP_Widget{
		...
		function form($instance){
			...
			<p><small><?php esc_html_e('Don\'t forget to fill your social profiles', 'epcl_framework'); ?> <a href="<?php echo admin_url(); ?>admin.php?page=ThemeOptionsPanel&tab=28"><?php esc_html_e('here', 'epcl_framework'); ?>.</a></small></p>
            <p>
