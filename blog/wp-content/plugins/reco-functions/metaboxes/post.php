...
acf_add_local_field_group( array(
	...
	'fields' => array (
        array (
            ...
            <p><b>For Single content (inside post):</b> 840x400px</p><p><b>Grids images on home:</b> 680x500px</p>
            <p><b>Classic posts on home:</b> 850x450px</p>
            <h3 style="margin-top: 0">Featured image recommended size:</h3>
            <p><b>Standard style:</b> 840x400px</p>
		...
		array (
			...
			'name' => 'style',
			'label' => esc_html__('Post Style', 'epcl_framework'),
        ...
        array (
			'key' => $prefix_key.'enable_download',
			'name' => 'enable_download',
			'label' => esc_html__('Enable Download Button', 'epcl_framework'),
			'instructions' => esc_html__('Enable/Disable download button for this post.', 'epcl_framework'),
			'type' => 'true_false',
			'default_value' => false,
			'ui' => true,
        ),
        array (
			'key' => $prefix_key.'download_title',
			'name' => 'download_title',
			'label' => esc_html__('Download Title (for the button)', 'epcl_framework'),
			'instructions' => esc_html__('e.g. Download Resource', 'epcl_framework'),
			'type' => 'text',
			'required' => false,
            'default_value' => esc_html__('Download Resource', 'epcl_framework'),
            'conditional_logic' => array (
                array (
                    array (
                    'field' => $prefix_key.'enable_download',
        ...
        array (
			'key' => $prefix_key.'download_url',
			'name' => 'download_url',
			'label' => esc_html__('Download URL (required)', 'epcl_framework'),
			'instructions' => esc_html__('Where the freebie is hosted, e.g. https://mega.nz/freebie', 'epcl_framework'),
			'type' => 'url',
			'required' => false,
            'default_value' => '',
            'conditional_logic' => array (
        ...
        array (
			'key' => $prefix_key.'download_counter',
			'name' => 'download_counter',
			'label' => esc_html__('Download Counter', 'epcl_framework'),
			'instructions' => esc_html__('How many times this freebie has been downloaded.', 'epcl_framework'),
			'type' => 'number',
			'readonly' => false,
            'default_value' => 0,
            'conditional_logic' => array (
