...
function epcl_welcome_page() {
    ...
    $base_config = array(
        ...
        'customizer_url' => admin_url( 'admin.php?page=ThemeOptionsPanel&tab=2' ),
    ...
    <div class="wrap about-wrap vlt-dashboard">
        ...
        <div class="epcl-dashboard-buttons">
            ...
            <a href="<?php echo $base_config['customizer_url']; ?>" target="_blank" class="button button-secondary">Start Customizing</a>
