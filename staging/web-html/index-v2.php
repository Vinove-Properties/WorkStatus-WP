...
<html lang="en">
   <head>
      ...
      <link type="text/css" href="https://bluzky.github.io/nice-select2/dist/css/nice-select2.css" rel="preload stylesheet" as="style" />
   ...
   <body>
      ...
      <div class="body__wrapper page__home">
         ...
         <main class="site__content">
                  ...
                  <div class="container">
                     <div class="flex_row">
                        <div class="column column-content">
                           <h1>Workforce Management Software With <strong>Integrated Workforce
                              Analytics</strong>
                           </h1>
                           <p>Optimize your workforce & workflow with effective tracking and smart reports.
                           </p>
                           <!-- <ul class="check">
                              <li>Track, analyze, and optimize your workforce efficiency</li>
                              <li>Automate manual employee data collection</li>
                              <li>Enhance employee productivity with actionable insights</li>
                              </ul> -->
                           <div class="actionBtn">
               ...
               <div class="container">
                  ...
                  <div class="exrow">
                     <div class="excol">
                        ...
                        <p>Rich reports with intelligent insights at every level</p>
                     </div>
                     <div class="excol">
                        <i class="icon2">
                        </i>
                        <h3>Cross-Device Compatibility</h3>
                        <p>Workstatus remains useful on all devices, all platforms</p>
                     </div>
                     <div class="excol">
                        <i class="icon3">
                        </i>
                        <h3>Data Security</h3>
                        <p>Restricted/Privileged access to users controlling data leaks</p>
                     </div>
                     <div class="excol">
                        <i class="icon4">
                        </i>
                        <h3>Easy Configuration</h3>
                        <p>Easy installation and single click start for tracking and reporting</p>
                     </div>
                     <div class="excol">
                        <i class="icon5">
                        </i>
                        <h3>Flexible Data Access</h3>
                        <p>Dashboard reports for analysis, APIs for internal integration and raw format for custom
                           usage
                        </p>
                     </div>
                     <div class="excol">
                        ...
                        <p>Easy access to support team via email, chat and calls</p>
                     </div>
                  </div>
                  <?php if( geoCTAcheck() === true ) : ?>
                  <div class="mt40 btnSc">
                     <p>Ready To Take Full Control Of Your Workplace?</p>
                     <a href="<?php echo $RegLink; ?>" class="primary_btn1"><?php echo $ws_ctas['cta_text']; ?></a>
                     <small>No credit card required</small>
                  </div>
                  <?php endif; ?>
            ...
            <section class="feature_section for-heading-center whitetxt">
               <div class="container">
                  <div class="top-section">
                     <h6><span class="bg-white">Other Features</span></h6>
                     <h2>Efficiently Manage Your Workforce With Workstatus</h2>
                  </div>
                     ...
                     <div class="column">
                        <div class="content">
                           <a href="<?php echo SITE_URL; ?>/best-time-tracking-software-online">
                              ...
                              <h3>Time Tracking</h3>
                              <p>Tracks and records employees time in timesheet for analytics</p>
                     ...
                     <div class="column">
                        <div class="content">
                           <a href="<?php echo SITE_URL; ?>/best-employee-productivity-cloud-software">
                              ...
                              <p>Productivity rates and patterns recorded allowing improvements
                              </p>
                              <span class="small_anchor">Explore</span>
                           </a>
                        </div>
                  ...
                  <div class="flex_row mt80">
                     <div class="column">
                        <div class="content">
                           <a href="<?php echo SITE_URL; ?>/geofence-time-clock-software-online">
                              ...
                              <h3>Geofencing</h3>
                              <p>Set geo-perimeters and automate remote employees’ attendance
                              </p>
                              <span class="small_anchor">Explore</span>
                           </a>
                        </div>
                     ...
                     <div class="column">
                        <div class="content">
                           <a href="<?php echo SITE_URL; ?>/best-attendance-management-software">
                              <span class="iconImg">
                                 <svg aria-hidden="true">
                                    <use
                                       xlink:href="./assests/images/icons/featuresicon.svg#attendance-management">
                                    </use>
                                 </svg>
                              </span>
                              <h3>Attendance Management</h3>
                              <p>Online and automated work time calculators for easy attendance
                              </p>
                              <span class="small_anchor">Explore</span>
                           </a>
                        </div>
                     ...
                     <div class="column">
                        <div class="content">
                           <a href="<?php echo SITE_URL; ?>/best-employee-monitoring-software-online">
                              ...
                              <p>Complete employee monitoring for activities and performance
                              </p>
                              <span class="small_anchor">Explore</span>
                           </a>
                        </div>
               ...
               <div class="container">
                  ...
                  <div class="glider-testimonial">
                     <div class="glider-contain">
                        <div class="glider2">
                           <div>
                              <p class="white">“ We were looking for an ease for our employees and in-depth
                           ...
                           <div>
                              <p class="white">“ Workstatus has given a significant boost to our business growth
                                 as our people are
                           ...
                           <div>
                              <p class="white">“ Workstatus has given us an edge by helping us in managing our
         ...
         <div class="banner-form wsf-signup">
            <div id="formPopup" class="popup-wrapper <?php echo ( isset( $_GET['book-demo'] ) ) ? ' is-active' : ''; ?>" style="display:block;">
               <div class="popWrap">
                  <div class="popup-content p-0">
                     <span class="cross-icon" style="z-index: 100;">
                     <img src="./assests/images/signup/cross.png" alt="">
                     </span>
                     <div class="left-section">
                        <picture>
                           <img loading="lazy" src="./assests/images/logo-white.svg" alt="Logo" width="179" height="24">
                        </picture>
                        <div class="content">
                           <h2>Experience the<span class="lt-blue">Power of Productivity </span>
                           </h2>
                           <p>Make your team 34%+ more efficient with Workstatus. All it takes is 2 minutes!
                           </p>
                           <h3>Why 13000+ users use <span class="lt-blue">Workstatus</span> daily</h3>
                        </div>
                        <div class="performer-box">
                           ...
                           <div class="second_box">
                              <img src="./assests/images/g2-main-image.svg" alt="">
                           </div>
                        </div>
                        <div class="badges">
                           <div class="col">
                              <div class="leftbar">
                                 <picture>
                                    <img loading="lazy" src="./assests/images/badge-logo1.svg" alt="Partner Logo" width="71" height="12">
                                 </picture>
                                 <i class="icon1"></i>
                              </div>
                              <div class="ritbar">
                           ...
                           <div class="col">
                              <div class="leftbar">
                                 <picture>
                                    <img loading="lazy" src="./assests/images/badge-logo2.svg" alt="Partner Logo" width="70" height="17">
                                 </picture>
                                 <i class="icon2"></i>
                              </div>
                              <div class="ritbar">
                           ...
                           <div class="col">
                              <div class="leftbar">
                                 <picture>
                                    <img loading="lazy" src="./assests/images/badge-logo3.svg" alt="Partner Logo" width="71" height="17">
                                 </picture>
                                 <i class="icon3"></i>
                              </div>
                              <div class="ritbar">
                           ...
                           <div class="col">
                              <div class="leftbar">
                                 <picture>
                                    <img loading="lazy" src="./assests/images/badge-logo4.svg" alt="Partner Logo" width="16" height="16">
                                 </picture>
                                 <i class="icon4"></i>
                              </div>
                              <div class="ritbar">
                        ...
                        <form>
                           <div class="form-wrap">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="infiled"  id="fname" placeholder="Full Name" name="fname" maxlength="30">
                                 <label>Full Name</label>
                                 <span class="error"></span>
                              </div>
                              <div class="form-group">
                                 <input  type="text" class="infiled" id="emailadd" placeholder="Email Address" name="email" maxlength="50">
                                 <label>"Email Address</label>
                                 <span class="error"></span>
                              </div>
                              <div class="form-group w-45">
                                 <select name="" id="ws-country" class="infiled">
                              ...
                              <div class="form-group w-55">
                                 <input  type="tel"  id="phone" class="infiled"  placeholder="Phone No" name="phone" maxlength="50">
                                 <label>Phone No</label>
                                 <span class="error"></span>
                              </div>
                              <div class="form-group">
                              <label>Full Name</label>
                                 <input type="password" class="infiled"  name="password" placeholder="Password" autocomplete="current-password" required="" id="id_password">
                                 <i  id="togglePassword" style="margin-left: -30px; cursor: pointer;">
                                 <img src="./assests/images/signup/eye.png"  alt=""></i>
                                 <label>Password</label>
                                 <span class="error"></span>
                              </div>
                              <div class="form-group">
                             
                                 <input type="password" class="infiled"  name="confirm password"  placeholder="Confirm Password" autocomplete="current-password" required="" id="id_password">
                                 <i id="togglePassword" style="margin-left: -30px; cursor: pointer;">
                                 <img src="./assests/images/signup/eye.png"  alt=""></i>
                              ...
                              <div class="form-group">
                                 ...
                                 <select class="infiled" name="" id="ws-emp">
                                    <option value=""></option>
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea class="infiled comment-input" name="requirement" id="ws-requirement" placeholder="Let us know what sparked our interest" 
                              ...
                              <div class="form-group">
                                 <div class="padd">
                                    <p><input class="mcheck" name="checkbox" type="checkbox" value="1" checked="">
                                       I've read and accept <a href="https://www.workstatus.io/terms-of-service" rel=" noopener">terms and conditions</a>
                                    </p>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <button type="submit" class="submtbtn" id="submitButton" name="submit" disabled="true">Create My Account</button>
                              </div>
                           </div>
                        </form>
                     </div>
      ...
      <script src="assests/js/glider.min.js"></script>
      <script src="https://bluzky.github.io/nice-select2/dist/js/nice-select2.js"></script>
      <script>
         NiceSelect.bind(document.getElementById("ws-country"),{placeholder:'Country Code*'});
         NiceSelect.bind(document.getElementById("ws-emp"),{placeholder:'Team Size'});
