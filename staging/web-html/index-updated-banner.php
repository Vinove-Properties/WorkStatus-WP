            ...
            <div class="container">
              <div class="flex_row">
                <div class="column column-content">
                  ...
                  <h1>Maximize Productivity With Smart Workforce New Test
                  </h1>
                  <div class="cont-wrap">
                    <p> Master Time, Workforce, Project Management, and Analytics for the Modern Businesses
                    </p>
                    <ul>
                      <li>Optimize Workload and Schedules For Teams</li>
                      <li>Improve Employee Performance & Efficiency</li>
                      <li>Make Data-Driven Decisions Using Analytics</li>
                    </ul>
                    <div class="actionBtn">
                ...
                <div class="column videoSc" id="has-yt-video">
                  <div class="award-badges">
                    ...
                    <picture>
                      <img loading="lazy" src="./assests/images/award-04.svg" alt="award" width="81" height="80">
                    </picture>
                    <picture>
                      <img loading="lazy" src="./assests/images/award-05.svg" alt="award" width="81" height="80">
                    </picture>
                  </div>
                  <div class="inner">
                    <button id="myBtn">
                    ...
                    <div class="topVideo srp-1">
                      <div id="myDIV" class="contbox2">
                        <div class="videoWrapper js-videoWrapper">
                          ...
                          <button style="background-image: url(./assests/images/home-poster.png)" class="videoPoster lazy-background nb-bg" id="play-button">
                          Play video
                          </button>
                        </div>
                      </div>
