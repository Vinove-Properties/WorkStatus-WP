...
$arr_vc9 = array('Monday','Tuesday','Wednesday','Thrusday','Friday','Saturday','Sunday','Total Hours Worked');
...
// echo $filename = "timesheet/timesheet_".$inputunique.".csv";
...
foreach($result as $rowfilteritems){
	...
	// $lineData .= 
		 ...
		 $lineData .= $rowfilteritems['day_item'].' : '.$totalhm.' hours.' ;
		 $lineData .= "%0D%0A";
...
echo  "%0D%0A";
echo $lineData;
echo 'Total Hours : '.$arr_vc8;
echo  "%0D%0A";
echo  "%0D%0A";
echo "Free time card generated by workstatus.io";
