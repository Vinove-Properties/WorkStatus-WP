      ...
      <div class="price-column">
          <div class="price-box">
            <div class="pr-plan">
              <span class="pr-icon">
                <picture>
                  <img loading="lazy" src="./assests/images/date-range.svg"
                    alt="workstatus" width="24" height="24">
                </picture>
              </span>
              <h3>Attendance <br>Management</h3>
              <div class="total">NO USER MINIMUM</div>
              <p>Tailored for companies seeking to improve productivity & track employee attendance.</p>
            </div>
            <div class="card-plan">
            <span class="wph" id="pl-product">₹49</span>
            <span class="prio monthly">/ user / month</span>
            </div>
            <a class="price_btn green-btn" href="#">Choose Plan</a>
            <div class="price-wrapper">
              <div class="price-options">
                ...
                <div class="option-list">
                  ...
                  <div class="option">Customizable Attendance Policies
                  </div>
                  <div class="option">Customizable Attendance Policies
                  </div>
                  <div class="option">Free Onboarding Support
