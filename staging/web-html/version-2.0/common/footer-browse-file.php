...
<div class="stickysec">
  ...
  <div id="myContacts">
    ...
    <ul>
      <li class="chat"><a onclick="$crisp.push(['do', 'chat:open'])"><i class="icon3"></i>Chat with us</a></li>
...
<div class="banner-form feature-form">
  <div id="featurePopup" class="popup-wrapper">
    <div class="popWrap">
      <div class="popup-content">
        <span class="closeicon"></span>
        <div class="top-section">
        ...
        <form id="contact-form-section" action="<?php echo SITE_URL; ?>/task-submission.php"
          ...
          <div class="form-wrap">
            ...
            <div class="form-group companygroup">
              <label>How important is this to you</label>
                <div class="switch-field">
                  <input type="radio" id="radio-one" class="custom-radio" name="switch-one" value="yes" checked>
                  <label for="radio-one">Good to have</label>
                  <input type="radio" id="radio-two" class="custom-radio" name="switch-one" value="no">
            ...
            <div class="form-group justify">
              ...
              <button type="submit" class="btn" id="submitButtons" name="submit">Book My Demo Now</button>
            </div>
          </div>
        </form>
      </div>
