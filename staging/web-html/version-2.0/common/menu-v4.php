  ...
  <div class="container">
    <div class="wrapper">
      <div class="header-item-left">
        <a href="https://www.workstatus.io/staging/" class="brand">
          <div class="large">
                ...
                <div class="container">
                  <div class="dis-flex tab-menu">
                    <div id="menu-serv" class="dis-flex tab-contents">
                      <div class="left-tabs">
                        <ul class="tab-nav">
                          <li class="tab-link is-active"><a href="#">Time & Attendance</a></li>
                          <li class="tab-link"><a href="#">WorkForce Management</a></li>
                          <li class="tab-link"><a href="#">Reporting & Analytics</a></li>
                          <li class="tab-link"><a href="#">Project & Task Management</a></li>
                        </ul>
                      </div>
                      <div class="right-tabs">
                        <div class="tab-content is-active">
                          <div class="three-column">
                            <div class="tab-title"><a href="#"><img loading="lazy" src="./assests/header-images/prod-01.svg" class="menuicon" alt="menuicon"><span class="title">Time & Attendance</span>
                          ...
                          <div class="other-menu mob-hide">
                            ...
                            <div class="flex-1 menu-column sub-service">
                              <a href="#"><img loading="lazy" src="./assests/header-images/mode-01.svg" class="menuicon" alt="menuicon"><span class="title">Remote Work</span>Track remote employees, easily
                              </a>
                              <a href="#"><img loading="lazy" src="./assests/header-images/mode-02.svg" class="menuicon" alt="menuicon"><span class="title">Hybrid Work</span>Optimize work-life balance
                              </a>
                              <a href="#"><img loading="lazy" src="./assests/header-images/mode-03.svg" class="menuicon" alt="menuicon"><span class="title">Field Work</span>Track work, on-the-go
                              </a>
                              <a href="#"><img loading="lazy" src="./assests/header-images/mode-04.svg" class="menuicon" alt="menuicon"><span class="title">Office Work</span>Manage in-office employees, easily
                              </a>
                            </div>
                          </div>
                        </div>
                        <div class="tab-content">
                          <div class="three-column">
                            <div class="tab-title"><a href="#"><img loading="lazy" src="./assests/header-images/prod-02.svg" class="menuicon" alt="menuicon"><span class="title">WorkForce Management</span>
                        ...
                        <div class="tab-content">
                          <div class="three-column">
                            <div class="tab-title"><a href="#"><img loading="lazy" src="./assests/header-images/prod-03.svg" class="menuicon" alt="menuicon"><span class="title">Reporting & Analytics</span>
                        ...
                        <div class="tab-content">
                          <div class="three-column">
                            <div class="tab-title"><a href="#"><img loading="lazy" src="./assests/header-images/prod-04.svg" class="menuicon" alt="menuicon"><span class="title">Project & Task Management</span>
                        ...
                        <div class="three-column">
                                <div class="dis-flex menu-column">
                                  <div class="flex-3">
                                    ...
                                    <a href="https://www.workstatus.io/use-cases" class="view-more">View More</a></div>
                                  </div>
                                  <div class="flex-3">
                                    <div class="tab-title"><a href="https://www.workstatus.io/staging/workforce-management/workplace-mode"><span class="title">Time Tracking</span>
                                      </a><span class="hr-arrow-btn"></span>
                          ...
                          <div class="other-menu mob-hide">
                            ...
                            <div class="flex-1 menu-column sub-service">
                              <a href="https://www.workstatus.io/staging/workplace-mode/remote-work-management"><img loading="lazy" src="./assests/header-images/enter-01.svg" class="menuicon" alt="menuicon"><span class="title">Workforce Management</span>Comprehensive support solutions
                              </a>
                              <a href="https://www.workstatus.io/staging/workplace-mode/hybrid-work-management"><img loading="lazy" src="./assests/header-images/enter-01.svg" class="menuicon" alt="menuicon"><span class="title">Workforce Optimization</span>Update your applications
                              </a>
                              <a href="https://www.workstatus.io/staging/workforce-management/field-service"><img loading="lazy" src="./assests/header-images/enter-01.svg" class="menuicon" alt="menuicon"><span class="title">Data Loss Prevention (DLP)</span>Monetize your content
                              </a>
                              <a href="https://www.workstatus.io/staging/workplace-mode/office-work"><img loading="lazy" src="./assests/header-images/enter-01.svg" class="menuicon" alt="menuicon"><span class="title">User Activity Monitoring</span>Cloud-based software solutions
                              </a>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="right-tabs">
                        <div class="tab-content is-active">
                          <div class="four-column">
                            <div class="tab-title"><a href="#"><img loading="lazy" src="./assests/header-images/ind-icon.svg" class="menuicon" alt="menuicon"><span class="title">Industries</span>
                        ...
                        <div class="tab-content">
                          <div class="three-column">
                            <div class="tab-title"><a href="#"><img loading="lazy" src="./assests/header-images/prod-01.svg" class="menuicon" alt="menuicon"><span class="title">By Role</span>
                          ...
                          <div class="other-menu mob-hide">
                            ...
                            <div class="flex-1 menu-column sub-service">
                              <a href="#"><img loading="lazy" src="./assests/header-images/os-01.svg" class="menuicon" alt="menuicon"><span class="title">OTT App Development</span>OTT App Development</a>
                              <a href="#"><img loading="lazy" src="./assests/header-images/os-02.svg" class="menuicon" alt="menuicon"><span class="title">Application Modernization</span>Update your applications</a>
                              <a href="#"><img loading="lazy" src="./assests/header-images/os-03.svg" class="menuicon" alt="menuicon"><span class="title">OTT App Development</span>OTT App Development</a>
                              <a href="#"><img loading="lazy" src="./assests/header-images/os-04.svg" class="menuicon" alt="menuicon"><span class="title">Application Modernization</span>Update your applications</a>
                            </div>
                          </div>
                        </div>
                      </div>
