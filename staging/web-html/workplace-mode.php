            ...
            <div class="step-row flex_row">
              ...
              <div class="content-col">
                <div class="top-section">
                  ...
                  <h2>How Workstatus Elevates Your Workplace?</h2>
                  <p>Embrace the future of remote, hybrid, and office work. Unlock the power of accurate insights and data-driven decisions.</p>
                  <ul>
                    <li>Fuel Collaboration & Productivity</li>
                    <li>Identify Opportunities for Growth</li>
                    <li>Optimize Team Performance</li>
                  </ul>
                  <p>From seamless remote work coordination to streamlined hybrid workflow and efficient office operations, Workstatus empowers you to lead your industry with data-driven decisions.</p>
                </div>
              </div>
            </div>
            <div class="step-row flex_row">
              ...
              <div class="content-col">
                <div class="top-section">
                  ...
                  <h2>Achieve More, Stress Less: Optimizing Workplace With Data-Rich Feature</h2>
                  <p>Boost your team's productivity with Workstatus's data-rich features for enhanced workplace efficiency by:</p>
                  <ul>
                    <li>Tracking Employee Activities</li>
          ...
          <div class="container">
            ...
            <div class="flex_row">
              <div class="column-three">
                ...
                <p>From tracking distributed teams to fostering seamless coordination, Workstatus empowers enterprises to achieve exceptional results.</p>
                </div>
              </div>
              <div class="column-three">
              <div class="box">
