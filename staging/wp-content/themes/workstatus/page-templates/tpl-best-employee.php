                    ...
                    <div class="client-stack award-animate-slide-to-left hover:pause">
                      <ul>
                        ...
                        <li>
                          ...
                          <picture class="awimg">
                            <img loading="lazy" src="<?php bloginfo('template_url'); ?>/dev-img/get-app.svg" alt="GetApp" width="108" height="20">
                          </picture>
                        </li>
                        <li>
                          ...
                          <picture class="awimg">
                            <img loading="lazy" src="<?php bloginfo('template_url'); ?>/dev-img/goodfirms.svg" alt="GoodFirms" width="119" height="18">
                          </picture>
                        </li>
                      </ul>
                    </div>
