<?php
/* 
Template Name: Use Case block Template 
Author : Gaurav K.
*/
get_header();
            ...
            <div class="item" id="ws-financial_management">
                <div class="container">
                    <div class="top-section">
                        ...
                        <?php echo $financialmanage['content']; ?>
                    </div>
                    ...
                    <?php /*if ($financialmanage['top_button_text']) { ?>
                        <div class="mt40 btnSc">
                            ...
                            <a href="<?php echo $financialmanage['cta_link']; ?>" class="primary_btn1"><?php echo $financialmanage['button_text']; ?></a>
                ...
                <div class="container">
                    ...
                    <?php /*if ($attendance_management['top_button_text']) { ?>
                        <div class="mt40 btnSc">
                            ...
                            <a href="<?php echo $attendance_management['cta_link']; ?>" class="primary_btn1"><?php echo $attendance_management['button_text']; ?></a>
