  ...
  <section class="table-tab padding-b-120">
    <div class="container">
      ...
      <div class="actionBtn">
        ...
        <div><a data-href="https://app.workstatus.io/auth/register/?pid=42&amp;type=monthly" href="javascript:void(0);" class="primary_btn2" onclick="return get_ws_signupform(this);">Start Free Trial</a><small>No credit card required</small></div>
      </div>
    </div>
  </section>
  <?php endif; ?>
