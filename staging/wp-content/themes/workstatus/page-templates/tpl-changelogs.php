    ...
    <table class="table1">
        ...
        //echo '<pre>'; print_r( $row ); die; ?>    
            ...
            <td colspan="6">
                ...
                echo substr($row->release_note, 0, 100).'...<a href="javascript:void(0)" onclick="popReleaseNote('.$index.')" class="note-link hide-excerpt" data-row="'.$index.'" style="font-size:16px;">Show Release Notes</a>';
                ?>                                        
                </div>
                </div>
            </td>    
