<?php 
/*
Template Name: Task Page Template
Author : Neearj Rai
*/ 
get_header();
...
<main class="site__content">
    ...
    <?php  
		...
		<section class="middle-section feature-section">
          ...
          if( $isEnable == "yes" ){ 
          ?>
		  <div class="item" id="ws-motivated_employees_section">
            <div class="container">
              <div class="top-section">
                ...
                <p><?php echo $motivated_employees_section['content']; ?></p>
              </div>
              <div id="active_Current_Tabs5">
                <div class="flex_row">
				  ...
				  <?php 
					...
					?>
                    <div class="all-content">
                      <div class="text-column active <?php echo (strpos($row['content'], '<ul') !== false) ? ' listing ' : ''; ?>" id="t<?php echo $i; ?>" data-section="active_Current_Tabs5">
                      <?php echo $row['content']; ?>
                      </div>
                      <div class="mob-image">
                        <?php if( $image ){
