<?php
$cta = ( isset($args['cta']) && !empty($args['cta']) ) ? $args['cta'] :  false;
?>
<section class="section-numbers <?php echo ( $cta !== false ) ? 'padding-t-120 padding-b-120' : ''; ?>">
<div class="container">
  ...
  <?php if((geoCTAcheck() === true) && ($cta === false) ){ ?>
