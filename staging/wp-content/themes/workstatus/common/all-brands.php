<section class="all-partners">
  <div class="top-section">
              ...
              <h2>The #1 Productivity Software</h2>
              <p>Workstatus: Transforming work data into success. Trusted for top-notch security, celebrated<br> support, and loved worldwide.</p>
            </div>
  <div class="container">
    <div class="part-row">
      <div class="part-col">
