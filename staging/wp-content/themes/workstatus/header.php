...
<head>
  ...
  <style type="text/css">
    ...
    .inner-banner .videoSc .srp-1 .videoPoster.wsbg-img{background-image:none;}
        ...
        <nav class="site_nav">
          <ul>
                    ...
                    <div class="flex_row">
                      ...
                      <div class="col-menu">
                        ...
                        <div class="menu-box">
                          ...
                          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assests/menu-images/sol-icon09.svg" width="20" height="20" alt="Menu Icon">Technology Companies
                          </a>
                          <a href="<?php echo site_url(); ?>/industry/digital-agencies">
                          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assests/menu-images/sol-icon10.svg" width="20" height="20" alt="Menu Icon">Digital Agencies
                          </a>
                          <a href="<?php echo site_url(); ?>/industry/staffing">
                          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assests/menu-images/sol-icon11.svg" width="20"
                            height="20" alt="Menu Icon">Staffing & Recruiting</a>
                          <a href="<?php echo site_url(); ?>/industry/bpo">
                          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assests/menu-images/sol-icon12.svg" width="20"
                            height="20" alt="Menu Icon">BPO & KPO
                          </a>
                          <a href="<?php echo site_url(); ?>/industry/contact-centers">
                          <img loading="lazy" src="<?php bloginfo('template_url'); ?>/assests/menu-images/sol-icon13.svg" width="20"
                            height="20" alt="Menu Icon">CX & Contact Center
                          </a>
                          <a href="<?php echo site_url(); ?>/industry" class="view-more">View More</a>
                        </div>
                      </div>
                      <div class="col-menu">
            ...
            <li id="apps" class="dropdown">
              <a href="<?php echo site_url(); ?>/apps" onclick="showAppsItem();">Apps & Integrations</a><span class="trigger" onclick="showAppsItem();"></span>
              <div class="full-menu">
                <div class="container">
                  <div class="flex_row">
                    <div class="col-menu">
