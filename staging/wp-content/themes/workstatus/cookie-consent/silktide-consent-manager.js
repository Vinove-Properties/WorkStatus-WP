...
class SilktideCookieBanner {
  constructor(config) {
    ...
    },
    {
      ...
      required: false,
      onAccept: function(){
        if( wsObj.hasOwnProperty('_env') && (wsObj._env == "production") && (typeof gtag === 'function') ){
  ...
  getBannerContent() {
    ...
    `<h3>This website uses cookies</h3><p>This website uses cookies to improve user experience. <a href=\"https://www.workstatus.io/privacy-policy\" target=\"_blank\">Read More</a><p>`;
